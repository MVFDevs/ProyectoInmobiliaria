...
$sel ->close();
 ...
 ?>
 <div class="row">
  <!- Cargarimagen principal ->
   <div class="col s6">
   <h2 class="header">Actualizar foto prinicipal</h2>
   <div class="card horizontal">
     ...
     <div class="card-stacked">
       <div class="card-content">
         <form action="up_principal.php" method="post" class="form" enctype="multipart/form-data">
    ...
    <div class="card">
      <div class="card-content">
        <?php
         ...
         <a href="#" class="" onclick="swal({title: 'Estás seguro de eliminar la imagen?',
         text: 'Al eliminarla no podras recuperarla',type: 'warning',showCancelButton: true,confirmButtonColor: '#3085d6',
         cancelButtonColor: '#d33',confirmButtonText: 'Sí, eliminarla'}).then(function () {
         location.href='eliminar_img.php?id=<?php echo $f_img['id'] ?>&ruta=<?php echo $f_img['ruta'] ?>&id_propiedad=<?php echo $id ?>';})"><img src="<?php echo $f_img['ruta'] ?>" alt=""></a>
       <?php }
       $sel_img->close();
       $con->close();
       ?>
