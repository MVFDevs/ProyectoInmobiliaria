   ...
   <div class="col s12 m6 l6">
     <div class="card blue-grey darken-1">
       ...
       <div class="card-action">
         <a href="../propiedades/index.php?ope=RENTA">Ver más</a>
       </div>
     </div>
   </div>
   <div class="col s12 m6 l6">
     <div class="card blue-grey darken-1">
       ...
       <div class="card-action">
         <a href="../propiedades/index.php?ope=VENTA">Ver más</a>
       </div>
     </div>
   </div>
   <div class="col s12 m6 l6">
     <div class="card blue-grey darken-1">
       ...
       <div class="card-action">
         <a href="../propiedades/index.php?ope=TRASPASO">Ver más</a>
       </div>
     </div>
   </div>
   <div class="col s12 m6 l6">
     <div class="card blue-grey darken-1">
       ...
       <div class="card-action">
         <a href="../propiedades/index.php?ope=OCUPADO">Ver más</a>
       </div>
     </div>
   </div>
 </div>
    ...
    <div class="card-content white">
      <div id="nuevos">
        <table>
           ...
           <tr>
             <td class="borrar"><button data-target="modal1" onclick="enviar(this.value)" value="<?php echo $fn['id_propiedad']?>" class="btn modal-trigger btn-floating"><i class="material-icons">visibility</i></button></td>
      ...
      <div id="resueltos">
        <table>
           ...
           while ($fn =$res_resuelto->fetch_assoc()) { ?>
           <tr>
             <td class="borrar"><button data-target="modal1" onclick="enviar(this.value)" value="<?php echo $fr['id_propiedad']?>" class="btn modal-trigger btn-floating"><i class="material-icons">visibility</i></button></td>
