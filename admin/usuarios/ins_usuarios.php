...
if (!ctype_alpha($nick)) {
  header('location:../extend/alerta.php?msj=Campo solo para letras&c=us&p=in&t=error');
  exit;
}
...
if ($usuario < 8  || $usuario > 15) {
  header('location:../extend/alerta.php?msj=El nick debe contener entre 8 y 15 carácteres&c=us&p=in&t=error');
  exit;
}
if ($contra < 8  || $contra > 15) {
  header('location:../extend/alerta.php?msj=El contraseña debe contener entre 8 y 15 carácteres&c=us&p=in&t=error');
  exit;
}
if (!empty($correo)) {
...
if ($archivo!='') {
  ...
  if ($extension == "png" || $extension == "PNG" || $extension == "jpg" || $extension == "JPG") {
    ...
    header('location:../extend/alerta.php?msj=Formato no valido&c=us&p=in&t=error');
    exit;
  }
}else{
