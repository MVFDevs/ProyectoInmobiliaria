...
if ($ins->execute()) {
  header('location:../extend/alerta.php?msj=Se guardo propiedad&c=prop&p=in&t=success');
}else{
  header('location:../extend/alerta.php?msj=No se pudo guardar la propiedad&c=cli&p=in&t=error');
}
$con->close();
  }else {
