        ...
        <table>
          ...
          while ($f =$res->fetch_assoc()) {?>
            <tr>
              ...
              <td><a href="cancelar_propiedad.php?id=<?php echo $f['propiedad']?>&accion=ACTIVO" class="btn-floating green"><i class="material-icons">autorenew</i></a></td>
              <td><a href="#" class="btn-floating red" onclick="swal({title: 'Estás seguro de cancelar la propiedad?', text:'Al eliminarla no podrá recuperarla',
              type: 'warning',showCancelButton: true,confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',confirmButtonText: 'Sí, eliminar'}).then(function () {
              location.href='eliminar_propiedad.php?id=<?php echo $f['propiedad'] ?>&foto=<?php echo $f['foto_principal'] ?>';})"><i class="material-icons">delete_forever</i></a></td>
            </tr>
          <?php }
          $sel->close();
          $con->close();
