...
$municipios = htmlentities($_POST['municipio']);
...
$sel_marc -> bind_param('ssssdd',$estado,$municipios,$operacion,$tipo_inmueble,$rango1,$rango2);
$sel_marc -> execute();
  ...
  <div class="col s12 m6 l3">
    <div class="card">
            <div class="card-image">
              ...
              <span class="card-title"><?php echo '$'.number_format($f_marc['precio'],0); ?></span>
            </div>
